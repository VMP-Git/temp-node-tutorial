...
/*Remember: In a terminal, sudo is a command that allows a user to execute commands with the 
security privileges of another user, typically the superuser (root). 
It stands for "superuser do". This is useful when you need to perform tasks that 
require administrative or root access, but you don't want to log in as the root user directly.*/
